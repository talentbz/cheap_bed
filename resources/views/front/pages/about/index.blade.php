            ...
            <div class="row justify-content-between">
                <div class="col-lg-6 wow" data-wow-offset="150">
                    <figure class="block-reveal">
                        ...
                        <img src="{{asset('/assets/Front/img/about_1.jpg')}}" class="img-fluid" alt="">
                    </figure>
                </div>
                <div class="col-lg-5">
        ...
        <div id="carousel" class="owl-carousel owl-theme">
            <div class="item">
                <a href="#0">
                    ...
                    </div><img src="{{asset('/assets/Front/img/1_carousel.jpg')}}" alt="">
                </a>
            </div>
            <div class="item">
                <a href="#0">
                    ...
                    </div><img src="{{asset('/assets/Front/img/2_carousel.jpg')}}" alt="">
                </a>
            </div>
            <div class="item">
                <a href="#0">
                    ...
                    </div><img src="{{asset('/assets/Front/img/3_carousel.jpg')}}" alt="">
                </a>
            </div>
            <div class="item">
                <a href="#0">
                    ...
                    </div><img src="{{asset('/assets/Front/img/4_carousel.jpg')}}" alt="">
                </a>
            </div>
            <div class="item">
                <a href="#0">
                    ...
                    </div><img src="{{asset('/assets/Front/img/5_carousel.jpg')}}" alt="">
                </a>
            </div>
        </div>
        <!-- /carousel -->
